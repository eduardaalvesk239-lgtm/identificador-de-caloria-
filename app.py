"""
Identificador de Calorias — versão Python (Streamlit)

Analisa uma foto de um prato de comida usando a API da OpenAI (gpt-5-mini,
com visão), estima valores nutricionais e indica se o prato parece ser
característico da culinária mineira.

Como rodar no VS Code:
    1. python -m venv .venv
    2. .venv\\Scripts\\activate        (Windows)   ou   source .venv/bin/activate  (macOS/Linux)
    3. pip install -r requirements.txt
    4. defina a variável de ambiente OPENAI_API_KEY (ou cole a chave na barra lateral)
